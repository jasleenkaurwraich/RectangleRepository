...
namespace Rectangle1
{
    class Program
    {
        ...
        public static void Rectpro(int option, ref Rectangle r)
        {
            switch (option)
            {
                case 1:
        ...
        public static void Main(string[] args)
        {
            ...
            rect.SetWidth(ValidateUserInput("width"));
            rect.SetLength(ValidateUserInput("length"));
            int Menu = 0;
            while (Menu != 7)
            {
                Menu = ValidateMenuSelection();
                Console.WriteLine("Menu  Option selected is  :: " + Menu);
                Rectpro(Menu, ref rect);
            }
        }
    }
}
